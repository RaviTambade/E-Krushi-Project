...
productid INT NOT NULL ,CONSTRAINT fkproduct1 FOREIGN KEY (productid) REFERENCES products(id)ON UPDATE CASCADE ON DELETE CASCADE,
quantity INT NOT NULL,discount DOUBLE DEFAULT 0,date DATETIME NOT NULL);
...
CREATE TABLE shippers(id INT NOT NULL AUTO_iNCREMENT PRIMARY KEY,
corporateid INT NOT NULL UNIQUE
userid INT NOT NULL,
...
CREATE TABLE subjectmatterexperts(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,expertise VARCHAR(40),userid INT NOT NULL);

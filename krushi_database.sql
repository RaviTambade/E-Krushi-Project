...
INSERT INTO payments(payment_date,payment_mode,user_id,order_id) VALUES('2022-03-08 12:08:39','cash on delivery',6,4);
...
INSERT INTO accounts(account_number,ifsc_code,register_date,user_id) VALUES('4105031206','AXIS0000286','2022-11-03  07:02:03',4);
INSERT INTO accounts(account_number,ifsc_code,register_date,user_id) VALUES('4105031207','BARB0000286','2022-10-23  08:02:03',3);
INSERT INTO accounts(account_number,ifsc_code,register_date,user_id) VALUES('4105031208','BARB0000286','2022-09-26  10:02:03',6);
...
-- show payment details of customer
SELECT * FROM payments WHERE user_id IN (SELECT user_id from users WHERE email IN (SELECT email from customers where first_name='pratiksha' AND last_name='bangar' AND contact_number='7834256798'));


-- show payment details of customers
SELECT * FROM accounts WHERE user_id IN(SELECT user_id FROM users WHERE email IN (SELECT email FROM customers WHERE first_name='pratiksha' AND last_name='bangar'AND contact_number='7834256798'));

-- show account_number, first_name ,user_id from customer,users,accounts;
SELECT accounts.account_number,customers.first_name,users.user_id from users,accounts,customers WHERE accounts.user_id = users.user_id AND cust_id =3;

-- available products in stocks
SELECT product_id,product_title,stock_available FROM products;

select * from categories;
select * from products;

-- this query gives category_id of products 
select category_id from products WHERE product_title = 'wood ash' ;

delete from products where product_id=8;
>>>>>>> 97352b6b955eea9f24655e6402c642bd5997f1ab
